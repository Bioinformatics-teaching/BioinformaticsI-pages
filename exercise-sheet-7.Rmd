...
- [ ] In the matrix representation of Markov chains, rows have to add up to 1.
- [ ] In the matrix representation of Markov chains, columns have to add up to 1.
...
- [ ] In the graph representation of Markov chains, a single state cannot have more than 3 outgoing edges.
- [x] In the matrix representation of Markov chains, rows have to add up to 1.
- [ ] In the matrix representation of Markov chains, columns have to add up to 1.
